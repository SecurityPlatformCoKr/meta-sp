...
do_sign_kernel() {
	...
	METASPRPI="${POKYDIR}/meta-sp/meta-sp-raspberrypi"
	...
	cp -f ${METASPRPI}/recipes-bsp/u-boot/files/bcm2709-rpi-2-b-pubkey.dtb ${TOPDIR}/signKernel/bcm2709-rpi-2-b.dtb
...
do_sign_kernel[doc] = "generate image.fit signed with meta-sp/keys/dev.key"
addtask sign_kernel before do_rpiboot_mkimage
