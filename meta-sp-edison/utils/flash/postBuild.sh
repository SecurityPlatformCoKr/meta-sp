...
bash ../sp/meta-sp/meta-sp-edison/utils/sign/signit.sh

# On ubuntu you need to install libqt4-core:i386 and libqt4-gui:i386 to run this script

top_repo_dir=$(dirname $(dirname $(dirname $(dirname $(dirname $(dirname $(readlink -f $0)))))))
...
env_dir=$top_repo_dir/sp/meta-sp/meta-sp-edison/recipes-bsp/u-boot/files
